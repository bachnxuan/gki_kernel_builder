...
def get_prepend_stack():  # -> Any | list[Any]:
    ...
def special_kwarg_validator(
    passed_kwargs, merged_kwargs, invalid_list
):  # -> list[Any]:
    ...
...
def determine_how_to_read_input(
    input_obj,
):  # -> tuple[Callable[[], Any] | Callable[[], Never], Literal['queue', 'callable', 'file descriptor', 'string', 'bytes', 'generator', 'None', 'general iterable']]:
...
def determine_how_to_feed_output(
    ...
    ...
def get_fd_chunk_consumer(
    handler, decode_errors
):  # -> tuple[Callable[..., Literal[False]], Callable[[], None]]:
    ...
def get_file_chunk_consumer(
    handler, decode_errors
):  # -> tuple[Callable[..., Literal[False]], Callable[[], None]]:
    ...
def get_callback_chunk_consumer(
    handler, encoding, decode_errors
):  # -> tuple[Callable[..., Any], Callable[[], None]]:
    ...
def get_cstringio_chunk_consumer(
    handler,
):  # -> tuple[Callable[..., Literal[False]], Callable[[], None]]:
    ...
...
def with_lock(
    lock,
):  # -> Callable[..., Callable[..., _GeneratorContextManager[None, None, None]]]:
    ...
